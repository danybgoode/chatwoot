...
<template>
  <div>
    <nav id="supernav">
      <!-- Left Side -->
      <a href="https://dashboard.despachobonsai.com" class="brand">{{
        $t('supernav.bonsai')
      }}</a>
      ...
      <div class="center-pills">
        <a
          href="https://dashboard.despachobonsai.com"
          class="pill"
      ...
      <div class="right-side">
        <a href="https://dashboard.despachobonsai.com" class="back-link">
          {{ $t('supernav.back') }}
        </a>
        <button
          class="mobile-menu-toggle"
          :aria-label="$t('supernav.menu_label')"
...
#supernav .center-pills .pill:first-child {
  border-left: none;
}
